...
function wa(a,b){a.l={Oa:b,Ta:!0};a.i=a.s||a.o}
...
function za(a){a.s=0;var b=a.l.Oa;a.l=null;return b}
function Aa(a){a.J=[a.l];a.s=0;a.o=0}
function Ba(a){var b=a.J.splice(0)[0];(b=a.l=a.l||b)?b.Ta?a.i=a.s||a.o:void 0!=b.u&&a.o<b.u?(a.i=b.u,a.l=null):a.i=a.o:a.i=0}
...
function Fa(a){for(;a.i.i;)try{var b=a.j(a.i);if(b)return a.i.v=!1,{value:b.value,done:!1}}catch(c){a.i.j=void 0,wa(a.i,c)}a.i.v=!1;if(a.i.l){b=a.i.l;a.i.l=null;if(b.Ta)throw b.Oa;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
b.prototype.eb=function(g){if(g===this)this.o(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.gb(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.cb(g):this.s(g)}};
b.prototype.cb=function(g){var h=void 0;try{h=g.then}catch(k){this.o(k);return}"function"==typeof h?this.hb(h,g):this.s(g)};
b.prototype.o=function(g){this.H(2,g)};
b.prototype.s=function(g){this.H(1,g)};
b.prototype.H=function(g,h){if(0!=this.i)throw Error("Cannot settle("+g+", "+h+"): Promise already settled in state"+this.i);this.i=g;this.l=h;2===this.i&&this.fb();this.J()};
b.prototype.fb=function(){var g=this;e(function(){if(g.ea()){var h=fa.console;"undefined"!==typeof h&&h.error(g.l)}},1)};
b.prototype.ea=function(){if(this.v)return!1;var g=fa.CustomEvent,h=fa.Event,k=fa.dispatchEvent;if("undefined"===typeof k)return!0;"function"===typeof g?g=new g("unhandledrejection",{cancelable:!0}):"function"===typeof h?g=new h("unhandledrejection",{cancelable:!0}):(g=fa.document.createEvent("CustomEvent"),g.initCustomEvent("unhandledrejection",!1,!0,g));g.promise=this;g.reason=this.l;return k(g)};
b.prototype.J=function(){if(null!=this.j){for(var g=0;g<this.j.length;++g)f.j(this.j[g]);this.j=null}};
var f=new c;b.prototype.gb=function(g){var h=this.m();g.ra(h.resolve,h.reject)};
b.prototype.hb=function(g,h){var k=this.m();try{g.call(h,k.resolve,k.reject)}catch(l){k.reject(l)}};
...
b.race=function(g){return new b(function(h,k){for(var l=u(g),m=l.next();!m.done;m=l.next())d(m.value).ra(h,k)})};
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,m){function q(y){return function(z){r[y]=z;p--;0==p&&l(r)}}
var r=[],p=0;do r.push(void 0),p++,d(k.value).ra(q(r.length-1),m),k=h.next();while(!k.done)})};
return b});
...
Bc.prototype.isEmpty=function(){return null==this.Ja};var Cc="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function Dc(a,b){Object.isFrozen(a)||(Cc?a[Cc]|=b:void 0!==a.X?a.X|=b:Object.defineProperties(a,{X:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
function Ec(a){var b;Cc?b=a[Cc]:b=a.X;return null==b?0:b}
...
function Mc(a,b){if(!Array.isArray(a))throw Error("cannot mark non-array as mutable");b?Dc(a,8):Object.isFrozen(a)||(Cc?a[Cc]&=-9:void 0!==a.X&&(a.X&=-9))}
...
;function Xc(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a&&!Array.isArray(a)){if(yc&&null!=a&&a instanceof Uint8Array)return xc(a);if(a instanceof Bc){var b=a.Ja;null!=b&&"string"!==typeof b&&(yc&&b instanceof Uint8Array?b=xc(b):(Na(b),b=null));return null==b?"":a.Ja=b}}}return a}
...
;function cd(a){return a.j||(a.j=a.C[a.l+a.W]={})}
function dd(a,b,c){return-1===b?null:b>=a.l?a.j?a.j[b]:void 0:(void 0===c?0:c)&&a.j&&(c=a.j[b],null!=c)?c:a.C[b+a.W]}
function F(a,b,c,d,e){d=void 0===d?!1:d;(void 0===e?0:e)||Rc(a);b<a.l&&!d?a.C[b+a.W]=c:cd(a)[b]=c;return a}
...
function hd(a,b,c,d,e){e=void 0===e?!1:e;var f=e;if(-1===c)d=null;else{a.i||(a.i={});var g=a.i[c];if(g)d=g;else{var h=dd(a,c,f);b=Wc(h,b,d);void 0==b?d=g:(d&&b.C!==h&&F(a,c,b.C,f,!0),a.i[c]=b,Nc(a)&&Lc(b.C),d=b)}}if(null==d)return d;Nc(d)&&!Nc(a)&&(d=d.Ia($b),F(a,c,d.C,e),a.i[c]=d);return d}
...
;function nd(a,b,c){a||(a=od);od=null;var d=this.constructor.j;a||(a=d?[d]:[]);this.W=(d?0:-1)-(this.constructor.i||0);this.i=void 0;this.C=a;a:{d=this.C.length;a=d-1;if(d&&(d=this.C[a],Oc(d))){this.l=a-this.W;this.j=d;break a}void 0!==b&&-1<b?(this.l=Math.max(b,a+1-this.W),this.j=void 0):this.l=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.l)a+=this.W,(d=this.C[a])?Array.isArray(d)&&Gc(d):this.C[a]=Qc;else{d=cd(this);var e=d[a];e?Array.isArray(e)&&Gc(e):d[a]=Qc}}
...
return a}
var Cd={Ab:"allow-forms",Bb:"allow-modals",Cb:"allow-orientation-lock",Db:"allow-pointer-lock",Eb:"allow-popups",Fb:"allow-popups-to-escape-sandbox",Gb:"allow-presentation",Hb:"allow-same-origin",Ib:"allow-scripts",Jb:"allow-top-navigation",Kb:"allow-top-navigation-by-user-activation"},Ed=bb(function(){return Dd()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,kb:function(){for(var q=d(),r="",p=0;p<q.length;p++)r+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return r}}}
...
function Ud(a){var b=Rd();b.update(a);return b.kb().toLowerCase()}
;var Vd={};function Wd(a){this.i=a||{cookie:""}}
n=Wd.prototype;n.isEnabled=function(){if(!A.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{Ca:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
...
function $d(a){var b=void 0===b?!1:b;var c=Pd(String(A.location.href)),d=[];var e=b;e=void 0===e?!1:e;var f=A.__SAPISID||A.__APISID||A.__3PSAPISID||A.__OVERRIDE_SID;Yd(e)&&(f=f||A.__1PSAPISID);if(f)e=!0;else{var g=new Wd(document);f=g.get("SAPISID")||g.get("APISID")||g.get("__Secure-3PAPISID")||g.get("SID");Yd(e)&&(f=f||g.get("__Secure-1PAPISID"));e=!!f}e&&(e=(c=0==c.indexOf("https:")||0==c.indexOf("chrome-extension:")||0==c.indexOf("moz-extension:"))?A.__SAPISID:A.__APISID,e||(e=new Wd(document),
...
ae.prototype.l=!1;ae.prototype.dispose=function(){this.l||(this.l=!0,this.ha())};
ae.prototype.ha=function(){if(this.o)for(;this.o.length;)this.o.shift()()};function be(a,b){this.type=a;this.i=this.target=b;this.defaultPrevented=this.l=!1}
...
Xa(he,be);var ie={2:"touch",3:"pen",4:"mouse"};
...
he.prototype.preventDefault=function(){he.N.preventDefault.call(this);var a=this.j;a.preventDefault?a.preventDefault():a.returnValue=!1};var je="closure_listenable_"+(1E6*Math.random()|0);var ke=0;function le(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.va=e;this.key=++ke;this.ka=this.qa=!1}
function me(a){a.ka=!0;a.listener=null;a.proxy=null;a.src=null;a.va=null}
;function ne(a){this.src=a;this.listeners={};this.i=0}
ne.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.i++);var g=oe(a,b,d,e);-1<g?(b=a[g],c||(b.qa=!1)):(b=new le(b,this.src,f,!!d,e),b.qa=c,a.push(b));return b};
...
function oe(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.ka&&f.listener==b&&f.capture==!!c&&f.va==d)return e}return-1}
;var qe="closure_lm_"+(1E6*Math.random()|0),re={},se=0;function te(a,b,c,d,e){if(d&&d.once)ue(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)te(a,b[f],c,d,e);else c=ve(c),a&&a[je]?a.Y(b,c,Pa(d)?!!d.capture:!!d,e):we(a,b,c,!1,d,e)}
...
function Ce(a){if("number"!==typeof a&&a&&!a.ka){var b=a.src;if(b&&b[je])pe(b.i,a);else{var c=a.type,d=a.proxy;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(ze(c),d):b.addListener&&b.removeListener&&b.removeListener(d);se--;(c=xe(b))?(pe(c,a),0==c.i&&(c.src=null,b[qe]=null)):me(a)}}}
function ze(a){return a in re?re[a]:re[a]="on"+a}
function Ae(a,b){if(a.ka)a=!0;else{b=new he(b,this);var c=a.listener,d=a.va||a.src;a.qa&&Ce(a);a=c.call(d,b)}return a}
...
return a[De]}
;function Ee(){ae.call(this);this.i=new ne(this);this.ea=this;this.H=null}
Xa(Ee,ae);Ee.prototype[je]=!0;Ee.prototype.addEventListener=function(a,b,c,d){te(this,a,b,c,d)};
Ee.prototype.removeEventListener=function(a,b,c,d){Be(this,a,b,c,d)};
function Fe(a,b){var c=a.H;if(c){var d=[];for(var e=1;c;c=c.H)d.push(c),++e}a=a.ea;c=b.type||b;"string"===typeof b?b=new be(b,a):b instanceof be?b.target=b.target||a:(e=b,b=new be(c,a),ub(b,e));e=!0;if(d)for(var f=d.length-1;!b.l&&0<=f;f--){var g=b.i=d[f];e=Ge(g,c,!0,b)&&e}b.l||(g=b.i=a,e=Ge(g,c,!0,b)&&e,b.l||(e=Ge(g,c,!1,b)&&e));if(d)for(f=0;!b.l&&f<d.length;f++)g=b.i=d[f],e=Ge(g,c,!1,b)&&e}
Ee.prototype.ha=function(){Ee.N.ha.call(this);if(this.i){var a=this.i,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,me(d[e]);delete a.listeners[c];a.i--}}this.H=null};
Ee.prototype.Y=function(a,b,c,d){return this.i.add(String(a),b,!1,c,d)};
function Ge(a,b,c,d){b=a.i.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.ka&&g.capture==c){var h=g.listener,k=g.va||g.src;g.qa&&pe(a.i,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
He.prototype.dispose=function(){window.removeEventListener("offline",this.s);window.removeEventListener("online",this.s);this.K.aa(this.J);delete He.i};
...
signal:f}),5);case 5:g=!0;case 3:Aa(h);a.v=void 0;a.m&&(a.K.aa(a.m),a.m=0);g!==a.j&&(a.j=g,a.j?Fe(a,"networkstatus-online"):Fe(a,"networkstatus-offline"));c(g);Ba(h);break;case 2:za(h),g=!1,h.u(3)}})})}
...
if("undefined"!==typeof a&&!E("Trident")&&!E("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.Ma;c.Ma=null;e()}};
...
Xa(vf,uf);vf.prototype.reset=function(){this.i[0]=1732584193;this.i[1]=4023233417;this.i[2]=2562383102;this.i[3]=271733878;this.i[4]=3285377520;this.m=this.j=0};
...
var kg=new df(function(){return new Nf},function(a){a.reset()});
function lg(a,b,c){var d=kg.get();d.j=a;d.onRejected=b;d.context=c;return d}
...
function qg(a,b,c,d){if(3==c&&b.onRejected&&!b.l)for(;a&&a.o;a=a.l)a.o=!1;if(b.i)b.i.l=null,vg(b,c,d);else try{b.l?b.j.call(b.context):vg(b,c,d)}catch(e){wg.call(null,e)}ef(kg,b)}
...
Xa(ng,Za);ng.prototype.name="cancel";function J(a){ae.call(this);this.v=1;this.m=[];this.s=0;this.i=[];this.j={};this.H=!!a}
Xa(J,ae);n=J.prototype;n.subscribe=function(a,b,c){var d=this.j[a];d||(d=this.j[a]=[]);var e=this.v;this.i[e]=a;this.i[e+1]=b;this.i[e+2]=c;this.v=e+3;d.push(e);return e};
function xg(a,b,c){var d=yg;if(a=d.j[a]){var e=d.i;(a=a.find(function(f){return e[f+1]==b&&e[f+2]==c}))&&d.oa(a)}}
n.oa=function(a){var b=this.i[a];if(b){var c=this.j[b];0!=this.s?(this.m.push(a),this.i[a+1]=function(){}):(c&&eb(c,a),delete this.i[a],delete this.i[a+1],delete this.i[a+2])}return!!b};
n.da=function(a,b){var c=this.j[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.H)for(e=0;e<c.length;e++){var g=c[e];zg(this.i[g+1],this.i[g+2],d)}else{this.s++;try{for(e=0,f=c.length;e<f&&!this.l;e++)g=c[e],this.i[g+1].apply(this.i[g+2],d)}finally{if(this.s--,0<this.m.length&&0==this.s)for(;c=this.m.pop();)this.oa(c)}}return 0!=e}return!1};
...
n.ha=function(){J.N.ha.call(this);this.clear();this.m.length=0};function Ag(a){this.i=a}
...
;function Gg(){}
Xa(Gg,Fg);Gg.prototype[Symbol.iterator]=function(){return Af(this.L(!0)).i()};
...
Xa(Hg,Gg);n=Hg.prototype;n.isAvailable=function(){if(!this.i)return!1;try{return this.i.setItem("__sak","1"),this.i.removeItem("__sak"),!0}catch(a){return!1}};
...
Xa(Og,Gg);Og.prototype.set=function(a,b){this.j.set(this.i+a,b)};
...
Pg.prototype.U=function(){return dd(this,2===gd(this,Qg)?2:-1)};
...
fh.prototype.U=function(){return md(this,2)};
...
(q=wd.screen)?void 0:q.availWidth;var r;e.u_cd=null==(r=wd.screen)?void 0:r.colorDepth}catch(W){}h=b.i;try{var p=h.screenX;var y=h.screenY}catch(W){}try{var z=h.outerWidth;var G=h.outerHeight}catch(W){}try{var K=h.innerWidth;var M=h.innerHeight}catch(W){}try{var P=h.screenLeft;var jb=h.screenTop}catch(W){}try{K=h.innerWidth,M=h.innerHeight}catch(W){}try{var uc=h.screen.availWidth;var ta=h.screen.availTop}catch(W){}p=[P,jb,p,y,uc,ta,z,G,K,M];y=b.i.top;try{var na=(y||window).document,X="CSS1Compat"==
...
function Ei(){return{innertubeApiKey:L("INNERTUBE_API_KEY"),innertubeApiVersion:L("INNERTUBE_API_VERSION"),Ba:L("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Qa:L("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),pb:L("INNERTUBE_CONTEXT_CLIENT_NAME",1),innertubeContextClientVersion:L("INNERTUBE_CONTEXT_CLIENT_VERSION"),Sa:L("INNERTUBE_CONTEXT_HL"),Ra:L("INNERTUBE_CONTEXT_GL"),qb:L("INNERTUBE_HOST_OVERRIDE")||"",sb:!!L("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),rb:!!L("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:L("SERIALIZED_CLIENT_CONFIG_DATA")}}
function Fi(a){var b={client:{hl:a.Sa,gl:a.Ra,clientName:a.Qa,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ba}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=A.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=L("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=ei();0<c.length&&(b.request={internalExperimentFlags:c});Gi(a,void 0,b);Hi(void 0,b);Ii(a,void 0,b);Ji(void 0,b);L("DELEGATED_SESSION_ID")&&!N("pageid_as_header_web")&&
...
function Gi(a,b,c){a=a.Qa;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=hd(b,Sg,96)||new Sg;var d=xi();d=Object.keys(wi).indexOf(d);d=-1===d?null:d;null!==d&&F(c,3,d);H(b,Sg,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=xi())}
...
function Li(a,b,c){c=void 0===c?{}:c;var d={};N("enable_web_eom_visitor_data")&&L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Rb||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Qb:b=$d([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),N("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
Ni.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.i)try{this.i.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Jf(b))}catch(f){return}else e=escape(b);b=this.j;Xd.set(""+a,e,{Ca:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
Ni.prototype.remove=function(a){this.i&&this.i.remove(a);var b=this.j;Xd.remove(""+a,"/",void 0===b?"youtube.com":b)};var Oi=window,O=Oi.ytcsi&&Oi.ytcsi.now?Oi.ytcsi.now:Oi.performance&&Oi.performance.timing&&Oi.performance.now&&Oi.performance.timing.navigationStart?function(){return Oi.performance.timing.navigationStart+Oi.performance.now()}:function(){return(new Date).getTime()};var Pi;function Qi(){Pi||(Pi=new Ni("yt.innertube"));return Pi}
function Ri(a,b,c,d){if(d)return null;d=Qi().get("nextId",!0)||1;var e=Qi().get("requests",!0)||{};e[d]={method:a,request:b,authState:Mi(c),requestTime:Math.round(O())};Qi().set("nextId",d+1,86400,!0);Qi().set("requests",e,86400,!0);return d}
function Si(a){var b=Qi().get("requests",!0)||{};delete b[a];Qi().set("requests",b,86400,!0)}
function Ti(a){var b=Qi().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(O())-d.requestTime)){var e=d.authState,f=Mi(Li(!1));mb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(O())),Ui(a,d.method,e,{}));delete b[c]}}Qi().set("requests",b,86400,!0)}}
;function Vi(){}
...
!1,pj.QUOTA_EXCEEDED=!1,pj.QUOTA_MAYBE_EXCEEDED=!0,pj.UNKNOWN_ABORT=!0,pj.INCOMPATIBLE_DB_VERSION=!1,pj);function Q(a,b,c,d,e){b=void 0===b?{}:b;c=void 0===c?mj[a]:c;d=void 0===d?oj[a]:d;e=void 0===e?qj[a]:e;gj.call(this,c,Object.assign({},{name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;this.i=e;Object.setPrototypeOf(this,Q.prototype)}
v(Q,gj);function rj(a,b){Q.call(this,"MISSING_OBJECT_STORES",{expectedObjectStores:b,foundObjectStores:a},mj.MISSING_OBJECT_STORES);Object.setPrototypeOf(this,rj.prototype)}
v(rj,Q);function sj(a,b){var c=Error.call(this);this.message=c.message;"stack"in c&&(this.stack=c.stack);this.index=a;this.objectStore=b;Object.setPrototypeOf(this,sj.prototype)}
...
function uj(a,b,c,d){b=kj(b);var e=a instanceof Error?a:Error("Unexpected error: "+a);if(e instanceof Q)return e;a={objectStoreNames:c,dbName:b,dbVersion:d};if("QuotaExceededError"===e.name)return new Q("QUOTA_EXCEEDED",a);if(tc&&"UnknownError"===e.name)return new Q("QUOTA_MAYBE_EXCEEDED",a);if(e instanceof sj)return new Q("MISSING_INDEX",Object.assign({},a,{objectStore:e.objectStore,index:e.index}));if("InvalidStateError"===e.name&&tj.some(function(f){return e.message.includes(f)}))return new Q("EXECUTE_TRANSACTION_ON_CLOSED_DB",
a);
if("AbortError"===e.name)return new Q("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",Vb:e.name})];e.level="WARNING";return e}
function vj(a,b,c){var d=bj();return new Q("IDB_NOT_SUPPORTED",{context:{caller:a,publicName:b,version:c,hasSucceededOnce:null==d?void 0:d.hasSucceededOnce}})}
...
T.all=function(a){return new T(new yj(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={Z:0};f.Z<a.length;f={Z:f.Z},++f.Z)zj(T.resolve(a[f.Z]).then(function(g){return function(h){d[g.Z]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})}))};
...
e()}))}
;function Gj(a,b){this.i=a;this.options=b;this.transactionCount=0;this.l=Math.round(O());this.j=!1}
...
function wk(a,b,c){a=a.i.createObjectStore(b,c);return new xk(a)}
...
function Hj(a,b,c,d){var e,f,g,h,k,l,m,q,r,p,y,z;return x(function(G){switch(G.i){case 1:var K={mode:"readonly",I:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?K.mode=c:Object.assign(K,c);e=K;a.transactionCount++;f=e.I?3:1;g=0;case 2:if(h){G.u(3);break}g++;k=Math.round(O());xa(G,4);l=a.i.transaction(b,e.mode);K=new zk(l);K=Ak(K,d);return w(G,K,6);case 6:return m=G.j,q=Math.round(O()),Bk(a,k,q,g,void 0,b.join(),e),G.return(m);case 4:r=za(G);p=Math.round(O());y=uj(r,a.i.name,b.join(),a.i.version);
if((z=y instanceof Q&&!y.i)||g>=f)Bk(a,k,p,g,y,b.join(),e),h=y;G.u(2);break;case 3:return G.return(Promise.reject(h))}})}
function Bk(a,b,c,d,e,f,g){b=c-b;e?(e instanceof Q&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&fj("QUOTA_EXCEEDED",{dbName:kj(a.i.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof Q&&"UNKNOWN_ABORT"===e.type&&(c-=a.l,0>c&&c>=Math.pow(2,31)&&(c=0),fj("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c}),a.j=!0),Ck(a,!1,d,f,b,g.tag),ej(e)):Ck(a,!0,d,f,b,g.tag)}
...
b.i.addEventListener("abort",function(){var e=b.i.error;if(e)d(e);else if(!b.j){e=Q;for(var f=b.i.objectStoreNames,g=[],h=0;h<f.length;h++){var k=f.item(h);if(null===k)throw Error("Invariant: item in DOMStringList is null");g.push(k)}e=new e("UNKNOWN_ABORT",{objectStoreNames:g.join(),dbName:b.i.db.name,mode:b.i.mode});d(e)}})})}
function Ak(a,b){var c=new Promise(function(d,e){try{zj(b(a).then(function(f){d(f)}),e)}catch(f){e(f),a.abort()}});
return Promise.all([c,a.done]).then(function(d){return u(d).next().value})}
zk.prototype.abort=function(){this.i.abort();this.j=!0;throw new Q("EXPLICIT_ABORT");};
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.yb,m=c.upgrade,q=c.closed,r;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&fj("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:kj(a)});var y=f(),z=new zk(g.transaction);
...
function Ok(a,b){return new Q("INCOMPATIBLE_DB_VERSION",{dbName:a.name,oldVersion:a.options.version,newVersion:b})}
function Pk(a,b){if(!b)throw vj("openWithToken",kj(a.name));return Qk(a)}
function Qk(a){function b(){var f,g,h,k,l,m,q,r,p,y;return x(function(z){switch(z.i){case 1:return g=null!=(f=Error().stack)?f:"",xa(z,2),w(z,a.l(a.name,a.options.version,d),4);case 4:h=z.j;for(var G=a.options,K=[],M=u(Object.keys(G.ja)),P=M.next();!P.done;P=M.next()){P=P.value;var jb=G.ja[P],uc=void 0===jb.wb?Number.MAX_VALUE:jb.wb;!(h.i.version>=jb.za)||h.i.version>=uc||h.i.objectStoreNames.contains(P)||K.push(P)}k=K;if(0===k.length){z.u(5);break}l=Object.keys(a.options.ja);m=h.objectStoreNames();
if(a.s<di("ytidb_reopen_db_retries",0))return a.s++,h.close(),ej(new Q("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),z.return(b());if(!(a.o<di("ytidb_remake_db_retries",1))){z.u(6);break}a.o++;if(!N("ytidb_remake_db_enable_backoff_delay")){z.u(7);break}return w(z,Mk(a.j),8);case 8:a.j*=2;case 7:return w(z,a.delete(),9);case 9:return ej(new Q("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),z.return(b());
...
;var Rk=new Nk("YtIdbMeta",{ja:{databases:{za:1}},upgrade:function(a,b){b(1)&&wk(a,"databases",{keyPath:"actualName"})}});
...
function Uk(a,b){var c,d;return x(function(e){return 1==e.i?(c=[],w(e,Pk(Rk,b),2)):3!=e.i?(d=e.j,w(e,Hj(d,["databases"],{I:!0,mode:"readonly"},function(f){c.length=0;return Ek(f.objectStore("databases"),{},function(g){a(g.U())&&c.push(g.U());return g.continue()})}),3)):e.return(c)})}
...
;new Kf;function bl(a){if(!hj())throw a=new Q("AUTH_INVALID",{dbName:a}),ej(a),a;var b=ij();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
...
;function jl(a){this.pa=this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.ca=function(){};
this.now=Date.now;this.ga=!1;var b;this.ab=null!=(b=a.ab)?b:100;var c;this.Za=null!=(c=a.Za)?c:1;var d;this.Xa=null!=(d=a.Xa)?d:2592E6;var e;this.Wa=null!=(e=a.Wa)?e:12E4;var f;this.Ya=null!=(f=a.Ya)?f:5E3;var g;this.A=null!=(g=a.A)?g:void 0;this.ta=!!a.ta;var h;this.sa=null!=(h=a.sa)?h:.1;var k;this.xa=null!=(k=a.xa)?k:10;a.handleError&&(this.handleError=a.handleError);a.ca&&(this.ca=a.ca);a.ga&&(this.ga=a.ga);a.pa&&(this.pa=a.pa);this.B=a.B;this.K=a.K;this.D=a.D;this.G=a.G;this.S=a.S;this.Fa=a.Fa;
this.Ea=a.Ea;kl(this)&&(!this.B||this.B("networkless_logging"))&&ll(this)}
function ll(a){kl(a)&&!a.ga&&(a.i=!0,a.ta&&Math.random()<=a.sa&&a.D.jb(a.A),ml(a),a.G.F()&&a.na(),a.G.Y(a.Fa,a.na.bind(a)),a.G.Y(a.Ea,a.La.bind(a)))}
...
f(g,h);k.i=0})}}this.S(a,b,e.skipRetry)}else this.D.set(e,this.A).catch(function(g){d.S(a,b,e.skipRetry);
ol(d,g)})}else this.S(a,b,this.B&&this.B("nwl_skip_retry")&&c)};
...
d.options.onSuccess=function(g,h){void 0!==d.id?c.D.ba(d.id,c.A):e=!0;c.G.R&&c.B&&c.B("vss_network_hint")&&c.G.R(!0);f(g,h)};
this.S(d.url,d.options);this.D.set(d,this.A).then(function(g){d.id=g;e&&c.D.ba(d.id,c.A)}).catch(function(g){ol(c,g)})}else this.S(a,b)};
n.na=function(){var a=this;if(!kl(this))throw vj("throttleSend");this.j||(this.j=this.K.O(function(){var b;return x(function(c){if(1==c.i)return w(c,a.D.Pa("NEW",a.A),2);if(3!=c.i)return b=c.j,b?w(c,nl(a,b),3):(a.La(),c.return());a.j&&(a.j=0,a.na());c.i=0})},this.ab))};
n.La=function(){this.K.aa(this.j);this.j=0};
function nl(a,b){var c,d;return x(function(e){switch(e.i){case 1:if(!kl(a))throw c=vj("immediateSend"),c;if(void 0===b.id){e.u(2);break}return w(e,a.D.ub(b.id,a.A),3);case 3:(d=e.j)?b=d:a.ca(Error("The request cannot be found in the database."));case 2:if(pl(a,b,a.Xa)){e.u(4);break}a.ca(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return w(e,a.D.ba(b.id,a.A),5);case 5:return e.return();case 4:b.skipRetry||(b=ql(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
void 0===b.id){e.u(8);break}return w(e,a.D.ba(b.id,a.A),8);case 8:a.S(b.url,b.options,!!b.skipRetry),e.i=0}})}
function ql(a,b){if(!kl(a))throw vj("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.i){case 1:g=rl(f);if(!(a.B&&a.B("nwl_consider_error_code")&&g||a.B&&!a.B("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.xa)){l.u(2);break}if(!a.G.la){l.u(3);break}return w(l,a.G.la(),3);case 3:if(a.G.F()){l.u(2);break}c(e,f);if(!a.B||!a.B("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){l.u(6);break}return w(l,a.D.Ga(b.id,a.A,!1),6);case 6:return l.return();case 2:if(a.B&&a.B("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.xa)return l.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){l.u(8);break}return b.sendCount<a.Za?w(l,a.D.Ga(b.id,a.A),12):w(l,a.D.ba(b.id,a.A),8);case 12:a.K.O(function(){a.G.F()&&a.na()},a.Ya);
case 8:c(e,f),l.i=0}})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){var g;return x(function(h){if(1==h.i)return void 0===(null==(g=b)?void 0:g.id)?h.u(2):w(h,a.D.ba(b.id,a.A),2);a.G.R&&a.B&&a.B("vss_network_hint")&&a.G.R(!0);d(e,f);h.i=0})};
return b}
function pl(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function ml(a){if(!kl(a))throw vj("retryQueuedRequests");a.D.Pa("QUEUED",a.A).then(function(b){b&&!pl(a,b,a.Wa)?a.K.O(function(){return x(function(c){if(1==c.i)return void 0===b.id?c.u(2):w(c,a.D.Ga(b.id,a.A),2);ml(a);c.i=0})}):a.G.F()&&a.na()})}
function ol(a,b){a.bb&&!a.G.F()?a.bb(b):a.handleError(b)}
function kl(a){return!!a.A||a.pa}
...
tl.prototype.l=function(a,b,c){c=void 0===c?{}:c;return(this.options.Ha?el:dl)(a,b,Object.assign({},c))};
tl.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Ha?il:fl)(this.name,a)};
function vl(a,b){return ul(a,b)}
;var wl;
function xl(){if(wl)return wl();var a={};wl=vl("LogsDatabaseV2",{ja:(a.LogsRequestsStore={za:2},a),Ha:!1,upgrade:function(b,c,d){c(2)&&wk(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3);c(5)&&(d=d.objectStore("LogsRequestsStore"),d.i.indexNames.contains("newRequest")&&d.i.deleteIndex("newRequest"),d.i.createIndex("newRequestV2",["status","interface","timestamp"],{unique:!1}));c(7)&&b.i.objectStoreNames.contains("sapisid")&&b.i.deleteObjectStore("sapisid");c(9)&&b.i.objectStoreNames.contains("SWHealthLog")&&b.i.deleteObjectStore("SWHealthLog")},
version:9});return wl()}
;function yl(a){return Pk(xl(),a)}
function zl(a,b){var c,d,e,f;return x(function(g){if(1==g.i)return c={startTime:O(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(g,yl(b),2);if(3!=g.i)return d=g.j,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:L("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(g,yk(d,e),3);f=g.j;c.zb=O();Al(c);return g.return(f)})}
function Bl(a,b){var c,d,e,f,g,h,k;return x(function(l){if(1==l.i)return c={startTime:O(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(l,yl(b),2);if(3!=l.i)return d=l.j,e=L("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,O()],h=IDBKeyRange.bound(f,g),k=void 0,w(l,Hj(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(m){return Hk(m.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(q){q.U()&&(k=q.U(),"NEW"===a&&(k.status="QUEUED",q.update(k)))})}),
3);
c.zb=O();Al(c);return l.return(k)})}
...
function Fl(a){var b,c;return x(function(d){if(1==d.i)return w(d,yl(a),2);b=d.j;c=O()-2592E6;return w(d,Hj(b,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(e){return Ek(e.objectStore("LogsRequestsStore"),{},function(f){if(f.U().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
;var Hl={},Il=vl("ServiceWorkerLogsDatabase",{ja:(Hl.SWHealthLog={za:1},Hl),Ha:!0,upgrade:function(a,b){b(1)&&wk(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function Jl(a){return Pk(Il(),a)}
function Kl(a){var b,c;x(function(d){if(1==d.i)return w(d,Jl(a),2);b=d.j;c=O()-2592E6;return w(d,Hj(b,["SWHealthLog"],{mode:"readwrite",I:!0},function(e){return Ek(e.objectStore("SWHealthLog"),{},function(f){if(f.U().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
;function Y(){Ee.call(this);var a=this;this.m=!1;this.j=Ke();this.j.Y("networkstatus-online",function(){if(a.m&&N("offline_error_handling")){var b=Sl().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new gj(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level;Ih(d)}Sl().set("errors",{},2592E3,!0)}}})}
...
n.vb=function(){};
n.ob=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
n.lb=function(){this.m=!0};
n.Y=function(a,b){return this.j.Y(a,b)};
n.la=function(a){a=Ie(this.j,a);a.then(function(b){N("use_cfr_monitor")&&Ql().requestComplete("generate_204",b)});
return a};
Y.prototype.sendNetworkCheckRequest=Y.prototype.la;Y.prototype.listen=Y.prototype.Y;Y.prototype.enableErrorFlushing=Y.prototype.lb;Y.prototype.getWindowStatus=Y.prototype.ob;Y.prototype.monitorNetworkStatusChange=Y.prototype.vb;Y.prototype.networkStatusHint=Y.prototype.R;Y.prototype.isNetworkAvailable=Y.prototype.F;Y.getInstance=Ul;function Vl(a){a=void 0===a?{}:a;Ee.call(this);var b=this;this.j=this.v=0;this.m=Ul();var c=B("yt.networkStatusManager.instance.listen").bind(this.m);c&&(a.ya?(this.ya=a.ya,c("networkstatus-online",function(){Wl(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Wl(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){Fe(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Fe(b,"publicytnetworkstatus-offline")})))}
v(Vl,Ee);Vl.prototype.F=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.m)():!0};
Vl.prototype.R=function(a){var b=B("yt.networkStatusManager.instance.networkStatusHint").bind(this.m);b&&b(a)};
Vl.prototype.la=function(a){var b=this,c;return x(function(d){c=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.m);return N("skip_network_check_if_cfr")&&Ql().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.R((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.F())})):c?d.return(c(a)):d.return(!0)})};
function Wl(a,b){a.ya?a.j?(Le.aa(a.v),a.v=Le.O(function(){a.s!==b&&(Fe(a,b),a.s=b,a.j=O())},a.ya-(O()-a.j))):(Fe(a,b),a.s=b,a.j=O()):Fe(a,b)}
;var Xl;function Yl(){jl.call(this,{D:{jb:Fl,ba:El,Pa:Bl,ub:Cl,Ga:Dl,set:zl},G:Zl(),handleError:Ih,ca:Jh,S:$l,now:O,bb:Tl,K:Zi(),Fa:"publicytnetworkstatus-online",Ea:"publicytnetworkstatus-offline",ta:!0,sa:.1,xa:di("potential_esf_error_limit",10),B:N,ga:!(hj()&&"www.youtube-nocookie.com"!==Qb(document.location.toString()))});this.l=new Kf;N("networkless_immediately_drop_all_requests")&&Gl();il("LogsDatabaseV2")}
v(Yl,jl);function am(){var a=B("yt.networklessRequestController.instance");a||(a=new Yl,C("yt.networklessRequestController.instance",a),N("networkless_logging")&&al().then(function(b){a.A=b;ll(a);a.l.resolve();a.ta&&Math.random()<=a.sa&&a.A&&Kl(a.A);N("networkless_immediately_drop_sw_health_store")&&bm(a)}));
return a}
...
function $l(a,b,c){N("use_cfr_monitor")&&cm(a,b);var d;if(null==(d=b.postParams)?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(O());c&&0===Object.keys(b).length?Ol(a):oi(a,b)}
function Zl(){Xl||(Xl=new Vl({tb:!0,mb:!0}));return Xl}
...
;var dm=0,em=0,fm,gm=A.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:!1,potentialEsfErrorCounter:em};C("ytNetworklessLoggingInitializationOptions",gm);function hm(a,b){function c(d){var e=im().F();if(!jm()||!d||e&&N("vss_networkless_bypass_write"))km(a,b);else{var f={url:a,options:b,timestamp:O(),status:"NEW",sendCount:0};zl(f,d).then(function(g){f.id=g;im().F()&&lm(f)}).catch(function(g){lm(f);
im().F()?Ih(g):Tl(g)})}}
b=void 0===b?{}:b;N("skip_is_supported_killswitch")?al().then(function(d){c(d)}):c($k())}
function mm(a,b){function c(d){if(jm()&&d){var e={url:a,options:b,timestamp:O(),status:"NEW",sendCount:0},f=!1,g=b.onSuccess?b.onSuccess:function(){};
e.options.onSuccess=function(k,l){N("use_cfr_monitor")&&Ql().requestComplete(e.url,!0);void 0!==e.id?El(e.id,d):f=!0;N("vss_network_hint")&&im().R(!0);g(k,l)};
...
b=void 0===b?{}:b;N("skip_is_supported_killswitch")?al().then(function(d){c(d)}):c($k())}
function nm(){var a=$k();if(!a)throw vj("throttleSend");dm||(dm=Le.O(function(){var b;return x(function(c){if(1==c.i)return w(c,Bl("NEW",a),2);if(3!=c.i)return b=c.j,b?w(c,lm(b),3):(Le.aa(dm),dm=0,c.return());dm&&(dm=0,nm());c.i=0})},100))}
function lm(a){var b,c,d;return x(function(e){switch(e.i){case 1:b=$k();if(!b)throw c=vj("immediateSend"),c;if(void 0===a.id){e.u(2);break}return w(e,Cl(a.id,b),3);case 3:(d=e.j)?a=d:Jh(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=O()-f)){e.u(4);break}Jh(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.u(5);break}return w(e,El(a.id,b),5);case 5:return e.return();case 4:a.skipRetry||(a=om(a));f=a;var g,h;if(null==
f?0:null==(g=f.options)?0:null==(h=g.postParams)?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(O());a=f;if(!a){e.u(0);break}if(!a.skipRetry||void 0===a.id){e.u(8);break}return w(e,El(a.id,b),8);case 8:km(a.url,a.options,!!a.skipRetry),e.i=0}})}
function om(a){var b=$k();if(!b)throw vj("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.i){case 1:N("use_cfr_monitor")&&Ql().requestComplete(a.url,!1);g=rl(f);if(!(N("nwl_consider_error_code")&&g||!N("nwl_consider_error_code")&&pm()<=di("potential_esf_error_limit",10))){l.u(2);break}if(N("skip_checking_network_on_cfr_failure")&&(!N("skip_checking_network_on_cfr_failure")||Ql().isEndpointCFR(a.url))){l.u(3);break}return w(l,im().la(),3);case 3:if(im().F()){l.u(2);break}c(e,f);if(!N("nwl_consider_error_code")||void 0===
...
a.options.onSuccess=function(e,f){var g;return x(function(h){if(1==h.i)return N("use_cfr_monitor")&&Ql().requestComplete(a.url,!0),void 0===(null==(g=a)?void 0:g.id)?h.u(2):w(h,El(a.id,b),2);N("vss_network_hint")&&im().R(!0);d(e,f);h.i=0})};
return a}
function im(){if(N("use_new_nwl"))return Zl();fm||(fm=new Vl({tb:!0,mb:!0}));return fm}
...
function Ui(a,b,c,d){function e(y){y=void 0===y?!1:y;var z;if(d.retry&&"www.youtube-nocookie.com"!=h&&(y||N("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(z=Ri(b,c,l,k)),z)){var G=g.onSuccess,K=g.onFetchSuccess;g.onSuccess=function(M,P){Si(z);G(M,P)};
c.onFetchSuccess=function(M,P){Si(z);K(M,P)}}try{y&&d.retry&&!d.Ua.bypassNetworkless?(g.method="POST",d.Ua.writeThenSend?N("use_new_nwl_wts")?am().writeThenSend(p,g):hm(p,g):N("use_new_nwl_saw")?am().sendAndWrite(p,g):mm(p,g)):(g.method="POST",g.postParams||(g.postParams={}),oi(p,g))}catch(M){if("InvalidAccessError"==M.name)z&&(Si(z),z=0),Jh(Error("An extension is blocking network request."));
...
function Pm(a,b,c,d){d=void 0===d?!1:d;a&&(Am=new a);a=di("tvhtml5_logging_max_batch")||di("web_logging_max_batch")||100;var e=O(),f=d?Dm.l:Cm.l,g=Hm.get(c)||[];N("jspb_with_transport_leader")&&(zm&&b.length+g.length>=a||!zm&&wm.ytExports.logging.transport.leaderQueueLength+b.length>=a)||b.length>=a?Lm({writeThenSend:!0},N("flush_only_full_queue")?c:void 0,d):10<=e-f&&(Rm(d),d?Dm.l=e:Cm.l=e)}
...
function Om(a,b){var c="";if(a.fa)c="visitorOnlyApprovedKey";else if(a.P){if(void 0===b?0:b){b=a.P.token;c=a.P;var d=new uh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&fd(d,2,vh,c.playlistId);Jm[b]=d}else b=a.P,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Im[a.P.token]=c;c=a.P.token}return c}
...
a?Dm.j=b:Cm.j=b}
function Tm(a,b,c,d,e){var f=Am;d=void 0===d?{}:d;var g=Math.round(O()),h=a.size;a=u(a);for(var k=a.next();!k.done;k=a.next()){var l=u(k.value);k=l.next().value;var m=l.next().value;l=k;k=nb({context:Fi(f.config_||Ei())});k.events=m;(m=Im[l])&&Wm(k,l,m);delete Im[l];l="visitorOnlyApprovedKey"===l;Xm(k,g,l);Ym(d);m=function(){h--;h||b()};
var q=function(){h--;h||b()};
try{Ui(f,"log_event",k,Zm(d,l,m,q,e)),Em=!1}catch(r){Ih(r),c()}}}
function Vm(a,b,c,d,e){var f=Am;d=void 0===d?{}:d;var g=Math.round(O()),h=a.size+b.size,k=new Map([].concat(ia(a),ia(b)));k=u(k);for(var l=k.next();!l.done;l=k.next()){var m=u(l.value).next().value,q=a.get(m),r=b.get(m)||[];l=new wh;var p=Ki(f.config_||Ei());H(l,bh,1,p);q=q?$m(q):[];q=u(q);for(p=q.next();!p.done;p=q.next())ld(l,3,rh,p.value);r=u(r);for(q=r.next();!q.done;q=r.next())ld(l,3,rh,q.value);(r=Jm[m])&&an(l,m,r);delete Jm[m];m="visitorOnlyApprovedKey"===m;bn(l,g,m);Ym(d);l=pd(l);m=Zm(d,m,
...
function Zm(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,Ua:a,fa:b,Tb:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
;var dn=A.ytLoggingGelSequenceIdObj_||{};C("ytLoggingGelSequenceIdObj_",dn);function en(a){Lm(void 0,void 0,void 0===a?!1:a)}
function fn(a){dn[a]=a in dn?dn[a]+1:0;return dn[a]}
;var gn=A.ytLoggingGelSequenceIdObj_||{};C("ytLoggingGelSequenceIdObj_",gn);function hn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:qm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||O());F(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=rm();d=new qh;F(d,1,b.timestamp||!isFinite(e)?-1:e);if(N("log_sequence_info_on_gel_web")&&b.ma){e=b.ma;var f=fn(e),g=new ph;F(g,2,f);F(g,1,e);H(d,ph,3,g);b.nb&&delete gn[b.ma]}H(a,qh,33,d);(b.xb?Um:Qm)({endpoint:"log_event",payload:a,P:b.P,fa:b.fa},c)}
;function jn(a,b){var c=void 0===c?{}:c;var d=qm;L("ytLoggingEventsDefaultDisabled",!1)&&qm==qm&&(d=null);c=void 0===c?{}:c;var e={},f=Math.round(c.timestamp||O());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=rm();e.context={lastActivityMs:String(c.timestamp||!isFinite(a)?-1:a)};N("log_sequence_info_on_gel_web")&&c.ma&&(a=e.context,b=c.ma,b={index:fn(b),groupKey:b},a.sequence=b,c.nb&&delete dn[c.ma]);(c.xb?Sm:Mm)({endpoint:"log_event",payload:e,P:c.P,fa:c.fa},d)}
;var kn=[{Da:function(a){return"Cannot read property '"+a.key+"'"},
...
wa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var mn={V:[],T:[{ib:ln,weight:500}]};function ln(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
;var qn=new J;function rn(a){function b(){return a.charCodeAt(d++)}
...
;function Dn(){var a;return x(function(b){return(a=cf())?b.return(a.then(function(c){c=pd(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return xc(d,3)})):b.return(Promise.resolve(null))})}
;var En={};function Fn(a){return En[a]||(En[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Gn={},Hn=[],yg=new J,In={};function Jn(){for(var a=u(Hn),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function Ln(a){yg.da.apply(yg,arguments)}
;function Mn(a){this.i=a||{};a=[this.i,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.toString().replace("http://","https://"))}
function Z(a,b){a=[a.i,window.YTConfig||{}];for(var c=0;c<a.length;c++){var d=a[c][b];if(void 0!==d)return d}return null}
function Nn(a,b,c){On||(On={},Rh(window,"message",function(d){a:{if(d.origin===Z(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=On[e.id])d.v=!0,d.v&&(D(d.s,d.sendMessage,d),d.s.length=0),d.Ka(e)}e=void 0}return e}));
On[c]=b}
var On=null;var Pn=window;function Qn(a,b,c){this.o=this.i=this.j=null;this.l=0;this.v=!1;this.s=[];this.m=null;this.J={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.H=c;this.setup(a,b)}
n=Qn.prototype;n.setSize=function(a,b){this.i.width=a.toString();this.i.height=b.toString();return this};
n.getIframe=function(){return this.i};
n.Ka=function(a){Rn(this,a.event,a)};
n.addEventListener=function(a,b){var c=b;"string"===typeof b&&(c=function(){window[b].apply(window,arguments)});
if(!c)return this;this.m.subscribe(a,c);Sn(this,a);return this};
function Tn(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.H===b[0]&&Sn(a,c)}}
n.destroy=function(){this.i&&this.i.id&&(Gn[this.i.id]=null);var a=this.m;a&&"function"==typeof a.dispose&&a.dispose();if(this.o){a=this.i;var b=a.parentNode;b&&b.replaceChild(this.o,a)}else(a=this.i)&&a.parentNode&&a.parentNode.removeChild(a);On&&(On[this.id]=null);this.j=null;a=this.i;for(var c in lb)lb[c][0]==a&&Ph(c);this.o=this.i=null};
n.Na=function(){return{}};
function Un(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.v?a.sendMessage(b):a.s.push(b)}
function Rn(a,b,c){a.m.l||(c={target:a,data:c},a.m.da(b,c),Ln(a.H+"."+b,c))}
...
b.toString());var g=a.Na();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&D(["debugjs","debugcss"],function(k){var l=Zb(window.location.href,k);null!==l&&(g[k]=l)});
Pn.yt_embedsTokenValue&&(g.embedsTokenValue=encodeURIComponent(Pn.yt_embedsTokenValue),delete Pn.yt_embedsTokenValue);var h=""+Z(a.j,"host")+("/embed/"+Z(a.j,"videoId"))+"?"+Tb(g);Pn.yt_embedsEnableUaChProbe?Dn().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Kd(l.href).toString();xd(c,Ld(k));return k}):
Pn.yt_embedsEnableIframeSrcWithIntent?xd(c,Ld(h)):c.src=h;
return c}
n.Va=function(){this.i&&this.i.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.l)};
function Wn(a){Nn(a.j,a,a.id);a.l=Th(a.Va.bind(a));Rh(a.i,"load",function(){window.clearInterval(a.l);a.l=Th(a.Va.bind(a))})}
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Rb(a.src):"https://www.youtube.com"),this.j=new Mn(b),c||(b=Vn(this,a),this.o=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.i=a,this.i.id||(this.i.id="widget"+Qa(this.i)),Gn[this.i.id]=this,window.postMessage){this.m=new J;Wn(this);b=Z(this.j,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in In)In.hasOwnProperty(e)&&
Tn(this,e)}};
function Sn(a,b){a.J[b]||(a.J[b]=!0,Un(a,"addEventListener",[b]))}
...
f.level&&(h=f.level);if(N("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=xn)){var m=void 0,q=void 0,r=f,p=g,y=ce(r),z=y.message||"Unknown Error",G=y.name||"UnknownError",K=y.stack||r.j||"Not available";
if(K.startsWith(G+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var P=y.lineNumber||"Not available",jb=y.fileName||"Not available",uc=K,ta=0;if(r.hasOwnProperty("args")&&r.args&&r.args.length)for(var na=0;na<r.args.length&&!(ta=tn(r.args[na],"params."+na,p,ta),500<=ta);na++);else if(r.hasOwnProperty("params")&&r.params){var X=r.params;if("object"===typeof r.params)for(q in X){if(X[q]){var ca="params."+q,da=vn(X[q]);p[ca]=da;ta+=ca.length+da.length;if(500<ta)break}}else p.params=vn(X)}if(An.length)for(var W=
0;W<An.length&&!(ta=tn(An[W],"params.context."+W,p,ta),500<=ta);W++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:G,lineNumber:P,fileName:jb,stack:uc,params:p,sampleWeight:1},Ij=Number(r.columnNumber);isNaN(Ij)||(S.lineNumber=S.lineNumber+":"+Ij);if("IGNORED"===r.level)m=0;else a:{for(var Jj=pn(),Kj=u(Jj.V),Of=Kj.next();!Of.done;Of=Kj.next()){var Lj=Of.value;if(S.message&&S.message.match(Lj.Ub)){m=Lj.weight;break a}}for(var Mj=u(Jj.T),
Pf=Mj.next();!Pf.done;Pf=Mj.next()){var Nj=Pf.value;if(Nj.ib(S)){m=Nj.weight;break a}}m=1}S.sampleWeight=m;for(var Oj=u(kn),Qf=Oj.next();!Qf.done;Qf=Oj.next()){var Rf=Qf.value;if(Rf.wa[S.name])for(var Pj=u(Rf.wa[S.name]),Sf=Pj.next();!Sf.done;Sf=Pj.next()){var Qj=Sf.value,Nd=S.message.match(Qj.regexp);if(Nd){S.params["params.error.original"]=Nd[0];for(var Tf=Qj.groups,Rj={},Vb=0;Vb<Tf.length;Vb++)Rj[Tf[Vb]]=Nd[Vb+1],S.params["params.error."+Tf[Vb]]=Nd[Vb+1];S.message=Rf.Da(Rj);break}}}S.params||(S.params=
{});var Sj=pn();S.params["params.errorServiceSignature"]="msg="+Sj.V.length+"&cb="+Sj.T.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));xb("sample").constructor!==wb&&(S.params["params.fconst"]="true");var qa=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(qa);if(0!==qa.sampleWeight&&!wn.has(qa.message)){if("ERROR"===h){qn.da("handleError",qa);if(N("record_app_crashed_web")&&
0===zn&&1===qa.sampleWeight)if(zn++,N("errors_via_jspb")){var Uf=new oh;F(Uf,1,1);if(!N("report_client_error_with_app_crash_ks")){var Tj=new jh;F(Tj,1,qa.message);var Uj=new kh;H(Uj,jh,3,Tj);var Vj=new lh;H(Vj,kh,5,Uj);var Wj=new mh;H(Wj,lh,9,Vj);H(Uf,mh,4,Wj)}var bo=Uf,Xj=new rh;jd(Xj,oh,20,sh,bo);hn(Xj)}else{var Yj={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};N("report_client_error_with_app_crash_ks")||(Yj.systemHealth={crashData:{clientError:{logMessage:{message:qa.message}}}});jn("appCrashed",Yj)}yn++}else"WARNING"===
h&&qn.da("handleWarning",qa);if(N("kevlar_gel_error_routing"))a:{var Vf=void 0,Wf=void 0,Hc=h,R=qa;if(N("errors_via_jspb")){if(Cn())Wf=void 0;else{var Wb=new gh;F(Wb,1,R.stack);R.fileName&&F(Wb,4,R.fileName);var Ia=R.lineNumber&&R.lineNumber.split?R.lineNumber.split(":"):[];0!==Ia.length&&(1!==Ia.length||isNaN(Number(Ia[0]))?2!==Ia.length||isNaN(Number(Ia[0]))||isNaN(Number(Ia[1]))||(F(Wb,2,Number(Ia[0])),F(Wb,3,Number(Ia[1]))):F(Wb,2,Number(Ia[0])));var ob=new jh;F(ob,1,R.message);F(ob,3,R.name);
F(ob,6,R.sampleWeight);"ERROR"===Hc?F(ob,2,2):"WARNING"===Hc?F(ob,2,1):F(ob,2,0);var Xf=new hh;F(Xf,1,!0);jd(Xf,gh,3,ih,Wb);var pb=new dh;F(pb,3,window.location.href);for(var Zj=L("FEXP_EXPERIMENTS",[]),Yf=0;Yf<Zj.length;Yf++){var ak=pb,co=Zj[Yf];Rc(ak);ed(ak,5).push(co)}var Zf=Dh();if(!Eh()&&Zf)for(var bk=u(Object.keys(Zf)),qb=bk.next();!qb.done;qb=bk.next()){var ck=qb.value,$f=new fh;F($f,1,ck);$f.setValue(String(Zf[ck]));ld(pb,4,fh,$f)}var ag=R.params;if(ag){var dk=u(Object.keys(ag));for(qb=dk.next();!qb.done;qb=
dk.next()){var ek=qb.value,bg=new fh;F(bg,1,"client."+ek);bg.setValue(String(ag[ek]));ld(pb,4,fh,bg)}}var fk=L("SERVER_NAME"),gk=L("SERVER_VERSION");if(fk&&gk){var cg=new fh;F(cg,1,"server.name");cg.setValue(fk);ld(pb,4,fh,cg);var dg=new fh;F(dg,1,"server.version");dg.setValue(gk);ld(pb,4,fh,dg)}var Od=new kh;H(Od,dh,1,pb);H(Od,hh,2,Xf);H(Od,jh,3,ob);Wf=Od}var hk=Wf;if(!hk)break a;var ik=new rh;jd(ik,kh,163,sh,hk);hn(ik)}else{if(Cn())Vf=void 0;else{var Ic={stackTrace:R.stack};R.fileName&&(Ic.filename=
R.fileName);var Ja=R.lineNumber&&R.lineNumber.split?R.lineNumber.split(":"):[];0!==Ja.length&&(1!==Ja.length||isNaN(Number(Ja[0]))?2!==Ja.length||isNaN(Number(Ja[0]))||isNaN(Number(Ja[1]))||(Ic.lineNumber=Number(Ja[0]),Ic.columnNumber=Number(Ja[1])):Ic.lineNumber=Number(Ja[0]));var eg={level:"ERROR_LEVEL_UNKNOWN",message:R.message,errorClassName:R.name,sampleWeight:R.sampleWeight};"ERROR"===Hc?eg.level="ERROR_LEVEL_ERROR":"WARNING"===Hc&&(eg.level="ERROR_LEVEL_WARNNING");var eo={isObfuscated:!0,browserStackInfo:Ic},
Xb={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(Xb.experimentIds=L("FEXP_EXPERIMENTS"));var fg=Dh();if(!Eh()&&fg)for(var jk=u(Object.keys(fg)),rb=jk.next();!rb.done;rb=jk.next()){var kk=rb.value;Xb.kvPairs.push({key:kk,value:String(fg[kk])})}var gg=R.params;if(gg){var lk=u(Object.keys(gg));for(rb=lk.next();!rb.done;rb=lk.next()){var mk=rb.value;Xb.kvPairs.push({key:"client."+mk,value:String(gg[mk])})}}var nk=L("SERVER_NAME"),ok=L("SERVER_VERSION");nk&&ok&&(Xb.kvPairs.push({key:"server.name",
value:nk}),Xb.kvPairs.push({key:"server.version",value:ok}));Vf={errorMetadata:Xb,stackTrace:eo,logMessage:eg}}var pk=Vf;if(!pk)break a;jn("clientError",pk)}if("ERROR"===Hc||N("errors_flush_gel_always_killswitch"))b:{if(N("web_fp_via_jspb")&&(en(!0),!N("web_fp_via_jspb_and_json")))break b;en()}}if(!N("suppress_error_204_logging")){var sb=qa,Jc=sb.params||{},Wa={urlParams:{a:"logerror",t:"jserror",type:sb.name,msg:sb.message.substr(0,250),line:sb.lineNumber,level:h,"client.name":Jc.name},postParams:{url:L("PAGE_NAME",
window.location.href),file:sb.fileName},method:"POST"};Jc.version&&(Wa["client.version"]=Jc.version);if(Wa.postParams){sb.stack&&(Wa.postParams.stack=sb.stack);for(var qk=u(Object.keys(Jc)),hg=qk.next();!hg.done;hg=qk.next()){var rk=hg.value;Wa.postParams["client."+rk]=Jc[rk]}var ig=Dh();if(ig)for(var sk=u(Object.keys(ig)),jg=sk.next();!jg.done;jg=sk.next()){var tk=jg.value;Wa.postParams[tk]=ig[tk]}var uk=L("SERVER_NAME"),vk=L("SERVER_VERSION");uk&&vk&&(Wa.postParams["server.name"]=uk,Wa.postParams["server.version"]=
vk)}oi(L("ECATCHER_REPORT_HOST","")+"/error_204",Wa)}try{wn.add(qa.message)}catch(jo){}xn++}}}}}else throw Ub;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function Xn(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Yn(a){return 0===a.search("get")||0===a.search("is")}
;function Zn(a,b){Qn.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.M={};this.playerInfo={};this.videoTitle=""}
v(Zn,Qn);n=Zn.prototype;n.Na=function(){var a=Z(this.j,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Z(this.j,"embedConfig")){if(Pa(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
n.Ka=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Pa(a))for(var c in a)a.hasOwnProperty(c)&&(this.M[c]=a[c]);break;case "infoDelivery":$n(this,a);break;case "initialDelivery":Pa(a)&&(window.clearInterval(this.l),this.playerInfo={},this.M={},ao(this,a.apiInterface),$n(this,a));break;default:Rn(this,b,a)}};
function $n(a,b){if(Pa(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.i.setAttribute("title",b))):(a.videoTitle="",a.i.setAttribute("title","YouTube "+Z(a.j,"title"))))}}
function ao(a,b){D(b,function(c){this[c]||("getCurrentTime"===c?this[c]=function(){var d=this.playerInfo.currentTime;if(1===this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:Xn(c)?this[c]=function(){this.playerInfo={};
...
C("YT.scan",Jn);C("YT.subscribe",function(a,b,c){yg.subscribe(a,b,c);In[a]=!0;for(var d in Gn)Gn.hasOwnProperty(d)&&Tn(Gn[d],a)});
...
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=gb(b);D(fb(a,b),fo)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Jn();var go=A.onYTReady;go&&go();var ho=A.onYouTubeIframeAPIReady;ho&&ho();var io=A.onYouTubePlayerAPIReady;io&&io();}).call(this);
